...
class TaskComposeViewController: UIViewController {
    ...
    //@IBOutlet weak var diaryField: UITextField!
    ...
    func configureTextView() {
            diaryField.text = "Enter your diary entry here..."
            diaryField.textColor = .lightGray
            // Customize your UITextView appearance and behavior as needed
        }
    ...
    func textViewDidEndEditing(_ textView: UITextView) {
            if textView.text.isEmpty {
                textView.text = "Enter your diary entry here..."
